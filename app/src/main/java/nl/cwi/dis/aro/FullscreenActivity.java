        ...
        btn1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if (user_name.length()==0)
                    {Toast.makeText(FullscreenActivity.this,"Pleas input your name!", Toast.LENGTH_LONG).show();}
                else if (user_age.length()==0)
                    {Toast.makeText(FullscreenActivity.this,"Pleas input your age!", Toast.LENGTH_LONG).show();}
                else if (user_gender.length()==0)
                {Toast.makeText(FullscreenActivity.this,"Pleas select your gender!", Toast.LENGTH_LONG).show();}
                else
                {
